...
🚀 **Live Demo:** 
https://sales-data-analyst-agent.streamlit.app/*
(You can explore this app even without local setup if you click on this link, make sure to upload the dataset from the link i mentioned in the end)*
